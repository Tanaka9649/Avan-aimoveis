...
export default async function OwnersPage() {
  ...
  return <div className="admin-content"><PageHeader eyebrow="Captação" title="Proprietários" description="Dados protegidos de proprietários e contatos vinculados aos imóveis."/>
