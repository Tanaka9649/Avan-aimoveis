...
export default async function ClientsPage() {
  ...
  return <div className="admin-content"><PageHeader eyebrow="Relacionamento" title="Clientes" description="Consulte contatos, origem e histórico comercial da sua carteira."/>
